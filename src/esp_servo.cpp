...
constexpr uint8_t kPwmFrequency = 10000;
...
EspServo::EspServo(const uint8_t pin,
                   const uint16_t min_angle,
                   const uint16_t max_angle,
                   const uint32_t min_pulse_width_us,
                   const uint32_t max_pulse_width_us)
    : pin_(pin),
